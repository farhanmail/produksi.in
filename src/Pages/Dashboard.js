...
import { Col, Container, Row, Image, Dropdown, Table, Form, Modal } from 'react-bootstrap';
                  ...
                  <Row>
                    ...
                    <Col sm={8}>
                      <div className="text-profil">
                        <h3>Hallo <text style={{color:'#035896'}}>Manager</text></h3>
              ...
              <h3>Statistik</h3>
                  ...
                  <Col>
                    <Row>
                      <Col className="d-flex justify-content-center">
                        <BiIcons.BiGroup style={{fontSize:'50px', color:'#FFCA42'}}/>
                      </Col>
                      <Col style={{textAlign:'center'}}>
                        <text style={{fontSize:'20px'}}><strong>300</strong></text>
                        <Col>
                          <text style={{fontSize:'10px', color:'grey'}}>Pegawai</text>
                        </Col>
                      </Col>
                    </Row>
                  </Col>
                  <Col>
                    <Row>
                      <Col className="d-flex pb-3 justify-content-center">
                        <FaIcons.FaWarehouse style={{fontSize:'48px', color:'#4642FF'}}/>
                      </Col>
                      <Col style={{textAlign:'center'}}>
                        <text style={{fontSize:'20px'}}><strong>30</strong></text>
                        <Col>
                          <text style={{fontSize:'10px', color:'grey'}}>Produk</text>
                        </Col>
                      </Col>
                    </Row>
                  </Col>
                ...
                <Row className="padding-statistik">
                  <Col>
                    <Row>
                      <Col className="d-flex justify-content-center">
                        <BsIcons.BsInboxesFill style={{fontSize:'45px', color:'#FF4D42'}}/>
                      </Col>
                      <Col style={{textAlign:'center'}}>
                        <text style={{fontSize:'20px'}}><strong>4</strong></text>
                        <Col>
                          <text style={{fontSize:'10px', color:'grey'}}>Kategori Produk</text>
                        </Col>
                      </Col>
                    </Row>
                  </Col>
                  <Col>
                    <Row>
                      <Col className="d-flex mb-2 justify-content-center">
                        <MdIcons.MdSell style={{fontSize:'50px', color:'#B742FF'}}/>
                      </Col>
                      <Col style={{textAlign:'center'}}>
                        <text style={{fontSize:'20px'}}><strong>323k</strong></text>
                        <Col>
                          <text style={{fontSize:'10px', color:'grey'}}>Total Produksi</text>
                        </Col>
                      </Col>
                    </Row>
                  </Col>
              ...
              <h3>Kategori Produk</h3>
                <Row>
                  <Col sm='5'>
                    <div class="shadow-sm bg-body rounded">
                      <div className="d-flex justify-content-center">
                        <Image className="image-data" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTRUhB044J0H_pcVbEe0qxV9aHSqcTqmjtggQ&usqp=CAU" rounded />
                      </div>
                  ...
                  <Col className="cursor" onClick={() => history.push(`/manajemen/kategori`)}>
                    <div className="d-flex justify-content-center">
          ...
          <Col>
            <div class="mt-3 rounded">
              <div className="button-dashboard"  onClick={() => history.push(`/manajemen/produksi/permintaan`)}>
                <h3 style={{textAlign:'center', fontSize:'22px'}}>Buat Permintaan Produksi</h3>
              </div>
              <div className="button-dashboard" onClick={() => history.push(`/manajemen/produksi/selesai`)}>
                <h3 style={{textAlign:'center', fontSize:'22px'}}>Lihat Produksi Dalam Proses</h3>
              </div>
            </div>
          </Col>
          <Col>
